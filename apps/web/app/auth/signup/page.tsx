...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-background hero-bg flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md border-border/40 bg-card/60 backdrop-blur-md shadow-2xl animate-fade-in relative z-10 my-8">
        <CardHeader className="text-center space-y-1">
          ...
          <CardDescription className="text-muted-foreground/80">
            Join Spamurai and automate your workflow
          </CardDescription>
        </CardHeader>
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              {providers && providers.length > 0 && providers.map((provider) => (
                ...
                >
                  ...
                  {provider.displayText || `Sign up with ${provider.displayName}`}
                </Button>
              ))}
            </div>
